...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::to('frontend/css/opensans-font.css')}}">
	<!-- datepicker -->
	<link rel="stylesheet" type="text/css" href="{{URL::to('frontend/css/jquery-ui.min.css')}}">

        <!-- Template Stylesheet -->
        <link href="{{URL::to('frontend/css/auth.css')}}" rel="stylesheet">
</head>
<body>
	...
	<script src="{{URL::to('frontend/js/jquery.steps.js')}}"></script>
